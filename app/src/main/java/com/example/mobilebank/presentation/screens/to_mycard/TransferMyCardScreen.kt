...
import com.example.mobilebank.presentation.dialog.MyCardsDialog
import com.example.mobilebank.ui.components.AddCardItem
                    ...
                    bottomSheetNavigator.show(
                        MyCardsDialog(
                            ...
                            itemClick = { cardData, i ->
                                ...
                                viewModel.onEventDispatcher(TransferMyCardContract.Intent.SelectedItem(cardData, i))
                            }
                        )
                    )
                }
    ...
    CustomAppBar(
        ...
        Box(
            ...
            Column {
                ...
                if (balanceIsCorrect) {
                    CustomTextView(
                        ...
                        text = if (itemsEquals) stringResource(id = R.string.error_to_my) else "${stringResource(id = R.string.transfer_percent)} 1% - $percent ${stringResource(id = R.string.money)}",
            ...
            CustomButton(
                ...
                click = {
                    onEventDispatcher(TransferMyCardContract.Intent.TransferMoney(selectedCardTo.id, data.pan, amount.toLong(), percent.toLong(), data))
                })
        }
    }
